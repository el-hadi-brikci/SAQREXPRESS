...
class UserController extends Controller
{
    public function index(Request $request)
    {
        ...
        $users = User::with(['region', 'bureau'])
            ...
            ->where('bureau_id', $currentBureauId)
            ->paginate(10);
        return view('adminBureau.users.index', compact('users'));
    }


    public function create()
    {
        $bureaux = \App\Models\Bureau::all();
        return view('adminBureau.users.create', compact('bureaux'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.bureau.users.index')->with('success', 'Employé créé avec succès.');
    }

    public function show(User $user)
    {
        return view('adminBureau.users.show', compact('user'));
    }
    ...
    public function edit(User $user)
    {
        ...
        return view('adminBureau.users.edit', compact('user', 'regions', 'bureaux'));
    }
    ...
    public function update(Request $request, User $user)
    {
        ...
        return redirect()->route('admin.bureau.users.index')->with('success', 'Utilisateur mis à jour avec succès.');
    }

    public function destroy(User $user)
    {
        $user->delete();
        return redirect()->route('admin.bureau.users.index')->with('success', 'Utilisateur supprimé avec succès.');
    }
    ...
    public function dashboard()
    {
        ...
        return view('dashboards.admin_bureau', compact('employes', 'colisList', 'clients'));
    }
}
