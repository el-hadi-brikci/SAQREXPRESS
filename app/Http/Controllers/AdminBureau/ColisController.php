...
class ColisController extends Controller
{
    ...
    public function create()
    {
        $clients = Client::all();
        $bureaux = Bureau::all();
        return view('adminBureau.colis.create', compact('clients', 'bureaux'));
    }
    ...
    public function store(Request $request)
    {
        ...
        // Resolve client by name or create
        ...
        return redirect()->route('admin.bureau.colis.index')
    ...
    public function show(Colis $colis)
    {
        ...
        return view('adminBureau.colis.show', compact('colis'));
    }
    ...
    public function edit(Colis $colis)
    {
        $clients = Client::all();
        $bureaux = Bureau::all();
        return view('adminBureau.colis.edit', compact('colis', 'clients', 'bureaux'));
    }
    ...
    public function ticket(Colis $colis)
    {
        ...
        return view('adminBureau.colis.ticket', compact('colis'));
    }
