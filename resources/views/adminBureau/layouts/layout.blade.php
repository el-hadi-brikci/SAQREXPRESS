...
<head>
  ...
  <title>@yield('title', 'Admin Bureau - Saqr-Express')</title>
  ...
  <nav class="bg-gradient-saqr text-white py-4 px-6 flex justify-between items-center">
    ...
    <ul class="flex items-center space-x-6">
      <li class="flex items-center">
        <a href="{{ route('admin.bureau.dashboard') }}" class="hover:text-[#FFA500]">
          Dashboard
        </a>
      </li>
      <li class="flex items-center">
        <a href="{{ route('admin.bureau.users.index') }}" class="hover:text-[#FFA500]">
          Employés
        </a>
      </li>
      <li class="flex items-center">
        <a href="{{ route('admin.bureau.colis.index') }}" class="hover:text-[#FFA500]">
          Colis
        </a>
      </li>
      <li class="flex items-center">
        <a href="{{ route('admin.bureau.clients.index') }}" class="hover:text-[#FFA500]">
          Clients
        </a>
      </li>
      <li class="flex items-center">
