...
<body>
    ...
    <div id="back-btn-container" style="text-align:center; margin-top:20px;">
        <button id="back-btn" onclick="window.history.back()" style="padding:8px 20px; background:#2563eb; color:#fff; border:none; border-radius:5px; font-size:16px; cursor:pointer;">⬅ Précédent</button>
    </div>
    ...
    <script>
        ...
        // Masquer le bouton précédent pendant l'impression
