...
<div class="max-w-6xl mx-auto mt-10">
    ...
    <div class="flex justify-end mb-4">
        <a href="{{ route('admin.global.clients.create') }}" 
            ...
            @forelse($clients as $client)
                <tr class="border-t hover:bg-gray-50">
                    ...
                    <td class="py-2 px-3 flex space-x-3">
                        <a href="{{ route('admin.global.clients.show', $client) }}" class="text-blue-600 hover:underline">Voir</a>
                        <a href="{{ route('admin.global.clients.edit', $client) }}" class="text-yellow-600 hover:underline">Modifier</a>
                        <form action="{{ route('admin.global.clients.destroy', $client) }}" method="POST" onsubmit="return confirm('Supprimer ce client ?')">
                            @csrf @method('DELETE')
