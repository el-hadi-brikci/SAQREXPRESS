            ...
            @forelse($colis as $c)
                <tr class="border-t hover:bg-gray-50">
                    ...
                    <td class="py-2 px-3 flex space-x-3">
                        <a href="{{ route('admin.region.colis.show', $c) }}" class="text-blue-600 hover:underline">Voir</a>
                        <a href="{{ route('admin.region.colis.edit', $c) }}" class="text-yellow-600 hover:underline">Modifier</a>
                    </td>
                </tr>
            @empty
                <tr>
