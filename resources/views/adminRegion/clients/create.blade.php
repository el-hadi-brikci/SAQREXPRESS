...
<div class="max-w-3xl mx-auto mt-10">
    ...
    <form method="POST" action="{{ route('admin.region.clients.store') }}" class="bg-white p-6 rounded shadow-md border border-gray-200">
        @csrf
        <div class="mb-4">
        ...
        <div class="mb-4">
            ...
            <input type="text" id="telephone" name="telephone" value="{{ old('telephone') }}" class="w-full border-gray-300 rounded px-3 py-2 shadow-sm focus:ring-saqr-blue focus:border-saqr-blue">
        ...
        <div class="flex justify-end mt-6">
            <a href="{{ route('admin.region.clients.index') }}" class="px-4 py-2 bg-gray-300 rounded hover:bg-gray-400 transition mr-2">Annuler</a>
